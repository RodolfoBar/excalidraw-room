...
var privateKey = fs.readFileSync(path.resolve(__dirname, '/home/rodolfo/certs/key.pem'));
var certificate = fs.readFileSync(path.resolve(__dirname, '/home/rodolfo/certs/cert.pem'));
